let detentions = document.querySelector("#detentionss");
let dchilds=detentions.children;
const detentionsLinks = [
...
for (let i = 0; i < dchilds.length; i++) {
   dchilds[i].addEventListener("click",()=>{
   window.open(`${detentionsLinks[i]}`, "_blank");
});
